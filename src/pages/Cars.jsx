...
const Cars = () => {
  ...
  const handleFilter = async () => {
    try {
      const response = await fetch(`http://64.227.147.171:4000/api/filtercars?make=${filtermake}&model=${searchTerm}&minPrice=${filter.minPrice}&maxPrice=${filter.maxPrice}`);
  ...
  const handleSearch = async () => {
    try {
      const response = await fetch(`http://64.227.147.171:4000/api/searchcars?name=${searchTerm}`);
  ...
  const fetchData = async () => {
    try {
      const response = await fetch("http://64.227.147.171:4000/api/getcars");
